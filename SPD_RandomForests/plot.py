...
a = np.fromfile('../prec_prediction_SEUS_RF_adjacent2.bin','float64').reshape(-1, 80, 72)
...
plt.xticks([])
plt.yticks([])
plt.title('Downscaled (add adjacent prec)')
plt.savefig('../../Figures/Downscaled_SEUS_lastday_adjacent2.png', format='PNG')
